...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getAllFilesOfADirectory($directory, $extension = '')
        {
                        return \Laranex\NextLaravel\NextLaravel::getAllFilesOfADirectory($directory, $extension);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\AppServiceProvider::registerBlueprintMacros()
         * @param mixed $column
         * @static 
         */ 
        public static function snowflakeId($column = 'id')
        {
                        return \Illuminate\Database\Schema\Blueprint::snowflakeId($column);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function snowflakeIdAndPrimary($column = 'id')
        {
                        return \Illuminate\Database\Schema\Blueprint::snowflakeIdAndPrimary($column);
        }
                    /**
         * 
         *
...
namespace  { 
             ...
             * 
             *
             * @see \App\Providers\AppServiceProvider::registerQueryBuilderMacros()
             * @param array|null $order
             * @param array $sortableFields
             * @static 
             */ 
            public static function purifySortingQuery($order, $sortableFields)
            {
                                return \Illuminate\Database\Eloquent\Builder::purifySortingQuery($order, $sortableFields);
            }
             ...
             * @static 
             */ 
            public static function search($searchableFields, $keyword)
            {
                                return \Illuminate\Database\Eloquent\Builder::search($searchableFields, $keyword);
            }
             ...
             * @static 
             */ 
            public static function cleanPaginate($perPage, $page)
            {
                                return \Illuminate\Database\Eloquent\Builder::cleanPaginate($perPage, $page);
            }
            ...
            class NextLaravel extends \Laranex\NextLaravel\Facades\NextLaravel {}
